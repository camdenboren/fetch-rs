...
fetch-rs simply grabs the date of the most recent commit on `main` (that passed CI builds) and compares it to the date of your current local commit (regardless of the branch). If the `main` commit is more recent, it rebuilds your system
